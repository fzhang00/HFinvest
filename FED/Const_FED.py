...
COMMERCIAL_PAPER_RATE = { "DCPF1M":'1M AA Financial'     ,
                          "DCPF2M":'2M AA Financial'     ,
                          "DCPF3M":'3M AA Financial'     ,
                          "DCPN30":'1M AA non-Financial' ,
                          "DCPN2M":'2M AA non-Financial' ,
                          "DCPN3M":'3M AA non-Financial' }
TREASURY_SEC_MARKET_RATE = {"DTB4WK" :'4 week'  ,
                             "DTB3"  :'3 month'  ,
                             "DTB6"  :'6 month'  ,
                             "DTB1YR":'1 year'   }


TREASURY_CONSTANT_MATURITY_RATE = {"DGS1MO" : '1 month'  ,
                                   "DGS3MO" : '3 month'  ,
                                   "DGS6MO" : '6 month'  ,
                                    "DGS1"  : '1 year'   ,
                                    "DGS2"  : '2 year'   ,
...
# # ---4 LIBOR not able to get data from server
# LIBOR = {'1 month': "USD1MTD156N",
        #  '3 month': "USD3MTD156N",
        #  '6 month': "USD6MTD156N"
# }

H15_RATE = {'Individual':{"FEDFUNDS" :'Fed Fund' ,
                          "DPRIME"   :'Bank Prime Loan Rate' ,
                          "DPCREDIT" :'Discount Window Primary Credit'} ,
            # 'LIBOR':LIBOR, # Not available in quandl.
            'Commercial Paper': COMMERCIAL_PAPER_RATE,
            'Treasury Secondary Market': TREASURY_SEC_MARKET_RATE,
            'Treasury Constant Maturity Rate': TREASURY_CONSTANT_MATURITY_RATE}
...
FRED_SYMBOL_LIST = {'H15':[sub_key for (key,value) in H15_RATE.items() for (sub_key, sub_value) in value.items()]}
