...
_sqlTable_SP500_Ratios_PE_TTM = 'SP500_Ratios_PE_TTM'

pd.set_option('mode.chained_assignment', None)

#-------dayly-------------
url_closePrice = 'https://www.gurufocus.com/economic_indicators/63/sp-500-index'
url_PE = 'https://www.gurufocus.com/economic_indicators/57/pe-ratio-ttm-for-the-sp-500'
url_divideYield =  'https://www.gurufocus.com/economic_indicators/150/sp-500-dividend-yield'
url_earningYield = 'https://www.gurufocus.com/economic_indicators/151/sp-500-earnings-yield'
...
def extrac_sql_guru_shillerRatio(csvFileFullPath, dbName):
    ...
    for colName, coldata in df.iteritems():
        if 'unnamed' in colName.lower():
            ...
            # print (i)
            # dbName = _sqlTable_SP500_Ratios_PE_TTM
...
# url = 'https://www.gurufocus.com/economic_indicators/57/pe-ttm-of-sp-500-index' 
...
url = 'https://www.gurufocus.com/economic_indicators/4202/sp-500-operating-eps-with-estimate-ttm'
